...
\begin{figure}[H]
	...
	\end{center}
\end{figure}
\bit{Cbc}{cbc} è un solver di programmazione lineare intera scritto in linguaggio \bit{C++}{cpp}, il motivo per cui si è scelto questo è la compatibilità con la libreria Google Or-Tools e la sua natura open source.
...
\begin{figure}[H]
	...
	\end{center}
\end{figure}
\bit{GitHub}{github} è un servizio di versionamento basato su repository \bit{git}{git}. Questo servizio permette di creare repository publbiche e private con cui versionare il proprio progetto, aspetto impontante nello sviluppo software.
