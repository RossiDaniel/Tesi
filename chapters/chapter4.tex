...
\begin{itemize}
	\item il vincolo~\eqref{equa11} impone che presi due oggetti almeno uno dei due oggetti si trovi alla sinistra o dietro all'altro;
...
\begin{itemize}
	...
	\item la variabile continua $\Delta_{i}$ con $i \in I$ assume il valore $d_i$ se l'oggetto è stato ruotato altrimenti $w_i$;
\end{itemize}
Il modello consiste delle seguenti variabili binarie:
\begin{itemize}
	\item la variabile binaria $l_{ij}$ con $i,j \in I$ assume il valore 1 se l'oggetto i è situato alla sinistra dell'oggetto j, altrimenti è 0;
...
\begin{figure}[!ht]
	\begin{center} \includegraphics[scale=0.3]{figures/abg_2drs}
		\caption[Vie scaricamento pacco]{Vie con cui scaricare un pacco.}  
		\label{fig:abg_2drs}
	\end{center}
\end{figure}
...
\begin{itemize}
	...
	\item 	\item la parametro binario $o_{ij}$ assume il valore 1 se l'oggetto i appartiene ad un ordine che deve essere scaricato prima dell'ordine a cui appartiene l'oggetto j, altrimenti è 0;
\end{itemize}
...
\begin{figure}[H]
	\begin{center} \includegraphics[scale=0.4]{figures/2d3d}
		\caption[corretta sequenza di scarico]{9 pacchi con corretta sequenza di scarico.}  
		\label{fig:2drs_abg}
	\end{center}
\end{figure}
...
Spiegiamo ora il significato di ciascun vincolo:
\begin{itemize}
	\item il vincolo~\eqref{equa30} impone che presi due oggetti almeno uno dei due si trovi o a sinistra o a destra dell'altro;
